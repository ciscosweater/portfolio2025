...
# Script para otimizar TODAS as imagens com ALTA QUALIDADE
# Converte PNG para WebP com resolução mantida e compressão de alta qualidade

echo "Iniciando otimização de TODAS as imagens com ALTA QUALIDADE..."
echo "============================================================="

# Encontra todas as imagens PNG
find public/assets/screenshots/ -type f -name "*.png" | while read img; do
    ...
    # Converte para WebP com ALTA QUALIDADE (95%) e mantém resolução original
    magick "$img" -quality 95 -define webp:lossless=false "$output"
...
original_total=$(find public/assets/screenshots/ -type f -name "*.png" -exec du -k {} \; | awk '{sum += $1} END {print sum}')
